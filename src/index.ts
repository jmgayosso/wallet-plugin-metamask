...
const defaultSnapOrigin = 'npm:@jmgayosso/antelopesnap'
const defaultSetupPageUrl = 'https://unicove.com/metamask'
const logo =
...
export class WalletPluginMetaMask extends AbstractWalletPlugin implements WalletPlugin {
    ...
    readonly metadata: WalletPluginMetadata = WalletPluginMetadata.from({
        ...
        homepage: 'https://unicove.com/metamask',
        download: 'https://unicove.com/metamask',
    })
